...
public class DeltaForm extends JFrame implements Runnable, MouseListener, MouseMotionListener {
	...
	private final double FPS = 29D;
	private final double UPS = 29D;
    ...
    public DeltaForm() {
    	...
    	// #2: Define window
        this.setUndecorated(true); // this line removes the
		...
		//this.setSize(Toolkit.getDefaultToolkit().getScreenSize()); // full screen
